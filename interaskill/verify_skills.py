...
Usage:
    python -m interaskill.verify_skills \
        ...
        --trajectories data/interaskill/processed/fabricated_trajectories.json
"""
...
from .paths import IW_FABRICATED_TRAJECTORIES
...
def main():
    ...
    parser.add_argument("--trajectories", type=str,
                        default=str(IW_FABRICATED_TRAJECTORIES))
