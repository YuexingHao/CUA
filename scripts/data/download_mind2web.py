...
Usage:
    python scripts/data/download_mind2web.py [--cache-dir PATH] [--max-tasks N]
"""
...
from interaskill.paths import MIND2WEB_CACHE_DIR
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default=str(MIND2WEB_CACHE_DIR),
