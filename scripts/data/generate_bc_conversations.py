...
from interaskill.paths import BROWSECOMP_CONVERSATIONS, BROWSECOMP_REPO_DIR, ensure_parent

BC_QUERIES = BROWSECOMP_REPO_DIR / "data/browsecomp_queries.jsonl"
BC_RUNS = BROWSECOMP_REPO_DIR / "data/decrypted_run_files/bm25/gpt5.jsonl"
OUTPUT_FILE = BROWSECOMP_CONVERSATIONS
...
def main():
    ...
    # Save
    with open(ensure_parent(OUTPUT_FILE), "w") as f:
