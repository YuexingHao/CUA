...
Produces:
    data/interaskill/processed/fabricated_trajectories.json
"""
...
from interaskill.paths import IW_FABRICATED_TRAJECTORIES, IW_SKILL_TEMPLATES, IW_SUMMARY, ensure_parent

SUMMARY_FILE = IW_SUMMARY
TEMPLATES_FILE = IW_SKILL_TEMPLATES
OUTPUT_FILE = IW_FABRICATED_TRAJECTORIES
