...
from interaskill.paths import WEBARENA_CONVERSATIONS, WEBARENA_TRAJECTORIES, ensure_parent

WA_TRAJS_FILE = WEBARENA_TRAJECTORIES
OUTPUT_FILE = WEBARENA_CONVERSATIONS
