...
Usage:
    python scripts/data/generate_conversations.py [--num 1000] [--seed 42]
"""
...
from interaskill.paths import IW_SKILL_TEMPLATES, IW_TRAIN_CONVERSATIONS, IW_VAL_CONVERSATIONS, ensure_parent

TEMPLATES_FILE = IW_SKILL_TEMPLATES
OUTPUT_TRAIN = IW_TRAIN_CONVERSATIONS
OUTPUT_VAL = IW_VAL_CONVERSATIONS
...
SCENARIOS = [
    {
        ...
        "user_messages": [
            ...
            "Now email the PDF to the leadership team — [contact] and [contact].",
        ],
        "corrections": [
    ...
    },
    {
        ...
        "user_messages": [
            ...
            "Now compose an email announcement to [contact] with the key highlights.",
        ],
        "corrections": [
            (1, "Actually, let's use the company announcement template, not a blank document."),
            (5, "Add the CEO as CC on that email — [contact]."),
        ],
    },
    {
...
FAILURE_SCENARIOS = [
    {
        ...
        "user_messages": [
            ...
            "Send to the distribution list: [contact].",
        ],
        "failures": [
            {
                "position": 1,
        ...
        "failures": [
            {
                ...
                "error": "My session credential for the Microsoft Graph API has expired. I need to re-authenticate to access calendar data.",
                "observation": "**[Error]** API call to `GET /me/calendar/events` returned HTTP 401 Unauthorized. Session credential expired at 2026-04-04T13:00:00Z.",
                "recovery": "reauth",
                "recovery_detail": "Refreshing the session credential using the refresh grant... Credential refreshed successfully. Retrying the request.",
                "recovery_success": True,
            },
            {
                "position": 3,
    ...
    },
    {
        ...
        "user_messages": [
            ...
            "Email the compliance summary to [contact].",
        ],
        "failures": [
            {
                "position": 0,
...
def fill_template(template: str) -> str:
    ...
    replacements = {
        ...
        "{recipient}": random.choice(["team lead", "project owner", "review group"]),
