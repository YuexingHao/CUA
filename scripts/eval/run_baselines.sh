...
from interaskill.paths import IW_FABRICATED_TRAJECTORIES, WEBARENA_TRAJECTORIES
...
print('=' * 70)
traj_iw = load_and_featurize(str(IW_FABRICATED_TRAJECTORIES))
...
print('=' * 70)
try:
    traj_wa = load_and_featurize(str(WEBARENA_TRAJECTORIES))
